...
Rectangle { // App icon
    ...
    color: Appearance.colors.notifications.iconBackground
    Loader {
        ...
        sourceComponent: MaterialSymbol {
            ...
            anchors.fill: parent
            color: (root.urgency == NotificationUrgency.Critical) ? Appearance.colors.notifications.iconUrgent : Appearance.colors.notifications.icon
