...
MouseArea { // Notification group area
    ...
    onContainsMouseChanged: {
        ...
        if (root.containsMouse)
            ...
            root.notifications.forEach(notif => {
                Notifications.restartTimeoutNotification(notif.notificationId);
            });
    }
    ...
    Rectangle { // Background of the notification
        ...
        width: parent.width
        color: popup ? ColorUtils.applyAlpha(Appearance.colors.notifications.groupBackground, 1 - Appearance.backgroundTransparency) : Appearance.colors.notifications.groupBackground
                ...
                Item { // App name (or summary when there's only 1 notif) and time
                    ...
                    RowLayout {
                        ...
                        StyledText {
                            ...
                            color: topRow.showAppName ? Appearance.colors.notifications.appName : Appearance.colors.notifications.summary
                        }
                        StyledText {
                            id: timeText
                            // Layout.fillWidth: true
                            ...
                            color: Appearance.colors.notifications.time
                        }
                    }
