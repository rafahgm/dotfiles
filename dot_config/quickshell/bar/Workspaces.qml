...
Item {
    ...
    Rectangle {
        ...
        color: Appearance.colors.workspaces.active
                ...
                background: Item {
                    ...
                    StyledText { // Workspace number text
                        ...
                        color: (monitor?.activeWorkspace?.id == button.workspaceValue) ? 
                            Appearance.colors.workspaces.textActive: 
                            (workspaceOccupied[index] ? Appearance.colors.workspaces.textOccupied : 
                                Appearance.colors.workspaces.textInactive)
                    ...
                    Rectangle { // Dot instead of ws number
                        ...
                        radius: width / 2
                        color: (monitor?.activeWorkspace?.id == button.workspaceValue) ? 
                            Appearance.colors.workspaces.dotActive : 
                            (workspaceOccupied[index] ? Appearance.colors.workspaces.dotOccupied : 
                                Appearance.colors.workspaces.dotInactive)
